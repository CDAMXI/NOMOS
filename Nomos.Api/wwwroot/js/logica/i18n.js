...
const I18N = {
  es: {
    ...
    color: 'Color', delete_category: 'Eliminar categoría',
    ...
    choose_photo: 'Elegir foto de perfil', theme_toggle: 'Cambiar tema', edit: 'Editar',
    ...
    edit_lot: '✏️ Editar compra', edit_lot_title: 'Editar compra de {0}',
  ...
  en: {
    ...
    more_chip: 'more',
    description_optional: 'Description (optional)', date_label: 'Date',
    delete_expense: 'Delete expense', delete_income: 'Delete income',
    expense_saved: 'Expense saved', income_saved: 'Income saved',
    movement_updated: 'Movement updated', expense_deleted: 'Expense deleted', income_deleted: 'Income deleted',
    undo: 'Undo', movement_restored: 'Movement restored',
    tap_confirm: 'Sure? Tap to confirm',
    ...
    color: 'Color', delete_category: 'Delete category',
    ...
    confirm_delete_user: 'This will delete your account and ALL your data (movements, accounts, categories…). This cannot be undone.',
    confirm_delete_user_btn: 'Delete permanently',
    ...
    choose_photo: 'Choose profile photo', theme_toggle: 'Toggle theme', edit: 'Edit',
    add_movement: 'Add movement', add_account_fab: 'Add account',
    ...
    edit_lot: '✏️ Edit purchase', edit_lot_title: 'Edit {0} purchase',
    lot_updated: 'Purchase updated', buy_date_label: 'Purchase date',
    margin_after: 'Margin after change',
    delete_lot: 'Delete purchase', lot_deleted: 'Purchase deleted — cost returned to margin',
    symbol_label: 'Name', price_paid_label: 'Purchase price',
    sell_price_label: 'Sell price', sell_all_chip: 'All',
