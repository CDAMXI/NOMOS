...
public class UserRepository(PlutoDbContext context) : RepositoryBase<User>(context), IUserRepository
{
...
public class CategoryRepository(PlutoDbContext context) : RepositoryBase<Category>(context), ICategoryRepository
{
...
public class ExpenseRepository(PlutoDbContext context) : RepositoryBase<Expense>(context), IExpenseRepository
{
...
public class IncomeRepository(PlutoDbContext context) : RepositoryBase<Income>(context), IIncomeRepository
{
...
public class AccountRepository(PlutoDbContext context) : RepositoryBase<Account>(context), IAccountRepository
{
...
public class HoldingRepository(PlutoDbContext context) : RepositoryBase<Holding>(context), IHoldingRepository
{
...
public class UnitOfWork(PlutoDbContext db) : IUnitOfWork
{
...
public class SnapshotRepository(PlutoDbContext db) : ISnapshotRepository
{
